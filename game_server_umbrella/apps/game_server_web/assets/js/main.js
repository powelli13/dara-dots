...
function preload ()
{
    ...
    this.load.image('dot', 'game_images/dot.png');
    this.load.image('boardDot', 'game_images/board_dot.png');
    this.load.image('altBoardDot', 'game_images/alt_board_dot.png');
    this.load.image('offBoardDot', 'game_images/offboard_dot.png');
    this.load.image('star', 'game_images/star.png');
    this.load.image('altStar', 'game_images/alt_star.png');
